...
class WritingLerrerEn extends StatefulWidget {
  const WritingLerrerEn({Key? key}) : super(key: key);

  @override
  State<WritingLerrerEn> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<WritingLerrerEn> {
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    _speak(borderLetter[itemCount].title);
                  },
                  child: CircleAvatar(
                    backgroundColor: colors3,
                    radius: 50,
